 ...
 */
 ...
 unsigned int NUM_IT	 = 10;									              // total number of iteration
...
__device__ float G = 6.674e-11f; 							          // Universal Gravitational constant: unit [m3⋅kg−1⋅s−2.]
__device__ float g_diameter 	= 376780.0f;				      // diameter of an element
__device__ float g_diameter2 	= 376780.0f * 376780.0f;	// diameter square of an element
__device__ float g_mass_si		= 7.4161e+19f;
__device__ float g_mass_fe		= 1.9549e+20f;
__device__ float g_k_si		= 2.9114e+11f;					      // repulsive parameter for silica
__device__ float g_k_fe		= 5.8228e+11f;					      // repulsive parameter for iron

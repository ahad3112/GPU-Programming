...
void nbody::startSimulation(){
  ...
  h_particles = allocateHostMemory(NUM_PARTICLES);
...
/*
  ...
  pthread_t windowThead;
  int t = pthread_create(&windowThead,NULL,startRendering,(void *) 1);
